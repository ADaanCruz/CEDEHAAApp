...
public class TeNotificationsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_te_notifications, container, false);

        notificaciones = (ListView) view.findViewById(R.id.lista_te_notificaciones);
